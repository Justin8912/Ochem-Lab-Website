...
export default function CourseSection (props) {
  if (props.class) {
    return (
      <div className={`relative shadow-lg text-center bg-white min-w-fit w-2/5 expanded-content max-h-fit mx-auto rounded-lg ease-linear bg-slate-50 transition-all duration-500 overflow-hidden mb-20`}>
