...
export default function CourseSection (props) {
  ...
  if (props.class) {
    return (
      <div className={`relative shadow-lg text-center bg-white w-2/4 expanded-content max-h-fit mx-auto rounded-lg ease-linear bg-slate-50 transition-all duration-500 overflow-hidden mb-20`}>
    ...
    return (
      <div className='text-center shadow-lg bg-white w-1/6 dropdown mx-auto rounded-lg bg-slate-50 transition-all duration-500 ease-linear mb-20'>
        <div onClick={props.accordian} class={` bg-${props.color}-50 rounded-lg py-5 px-10`} id={props.idHandle}>
