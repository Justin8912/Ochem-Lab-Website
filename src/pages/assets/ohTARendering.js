  ...
  if (props.class) {
    return (
      <div className={`relative shadow-lg text-center bg-white w-2/5 expanded-content max-h-fit mx-auto rounded-lg ease-linear bg-slate-50 transition-all duration-500 overflow-hidden mb-20`}>
        <div onClick={props.accordian} className={`grid grid-cols-7 ${props.color} py-5 px-10`} id={props.idHandle}>
    ...
    return (
      <div className='text-center shadow-lg bg-white w-1/5 xl:w-1/6 dropdown mx-auto rounded-lg bg-slate-50 transition-all duration-500 ease-linear mb-20'>
        <div onClick={props.accordian} class={`grid grid-cols-7 ${props.color} rounded-lg py-5 px-10`} id={props.idHandle}>
